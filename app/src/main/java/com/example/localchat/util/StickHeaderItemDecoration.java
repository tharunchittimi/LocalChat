...
public class StickHeaderItemDecoration extends RecyclerView.ItemDecoration {
    ...
    /**
     * Instantiates a new Stick header item decoration.
     *
    ...
    /**
     * Gets header view for item.
     *
     * @param headerPosition the header position
     * @param parent         the parent
     * @return the header view for item
     */
    ...
    /**
     * Gets child in contact.
     *
     * @param parent           the parent
     * @param contactPoint     the contact point
     * @param currentHeaderPos the current header pos
     * @return the child in contact
     */
    ...
    /**
     * The interface Sticky header interface.
     */
